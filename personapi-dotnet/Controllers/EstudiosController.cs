...
namespace personapi_dotnet.Controllers
{
    public class EstudiosController : Controller
    {
        ...
        public EstudiosController(ArqPerDbContext context)
        {
            _context = context;
        }
        ...
        {
            var arqPerDbContext = _context.Estudios.Include(e => e.CcPerNavigation).Include(e => e.IdProfNavigation);
            return View(await arqPerDbContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ArqPerDbContext.Estudios'  is null.");
            }
            var estudio = await _context.Estudios.FindAsync(id);
            if (estudio != null)
            {
