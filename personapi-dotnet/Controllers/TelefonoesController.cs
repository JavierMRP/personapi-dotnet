...
namespace personapi_dotnet.Controllers
{
    public class TelefonoesController : Controller
    {
        ...
        public TelefonoesController(ArqPerDbContext context)
        {
            _context = context;
        }
        ...
        {
            var arqPerDbContext = _context.Telefonos.Include(t => t.DuenioNavigation);
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'ArqPerDbContext.Telefonos'  is null.");
            }
            var telefono = await _context.Telefonos.FindAsync(id);
            if (telefono != null)
            {
